...
preview's Thunderbird profile preferences. Changelog now has local search, date filters,
...
- If profile preferences are unavailable, defaults remain usable and a
  non-blocking toast reports that persistence was unavailable.
