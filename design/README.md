...
| Appearance editor and infinite color translator | Packaged anchored editor plus persisted accent/font/scale/weight foundation | Add every-element coverage, Word-depth typography, full color-space translation, persistence presets, import/export, and reset depth. |
